  ...
  return (
    <div className="flex flex-col w-full m-5 ml-[16.875rem]">
      ...
      <form
        ...
        className="bg-white dark:bg-[#060c11] shadow-sm  rounded-md flex flex-col gap-2 border border-[#DADCE2] p-4"
      >
        ...
        <div className="flex flex-wrap items-center max-w-2xl gap-2">
